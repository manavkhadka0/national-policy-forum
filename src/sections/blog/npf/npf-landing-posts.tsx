...
import PostItem from './npf-landing-post-item';
import PostItemCarousel from './npf-landing-post-item-carousel';
...
export default function NpfLatestPost({ posts }: Props) {
