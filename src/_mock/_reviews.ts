...
export const _reviews = [
  {
    ...
    replyComment: [
      ...
      },
      {
        ...
        created_at: _mock.time(3),
      },
      {
        id: _mock.id(3),
        userId: users[2].id,
        message: _mock.sentence(4),
        created_at: _mock.time(4),
      },
    ],
  },
  {
    ...
    replyComment: [
      {
        ...
        created_at: _mock.time(7),
      },
      {
        id: _mock.id(6),
        userId: users[7].id,
        message: _mock.sentence(8),
        created_at: _mock.time(8),
      },
    ],
  },
  {
